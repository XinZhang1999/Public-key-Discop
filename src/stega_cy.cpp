 ...
 */
      if (!(likely(PyList_CheckExact(__pyx_v_indices))||((__pyx_v_indices) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "list", Py_TYPE(__pyx_v_indices)->tp_name), 0))) __PYX_ERR(0, 426, __pyx_L1_error)
      if (!(likely(PyList_CheckExact(__pyx_v_probs))||((__pyx_v_probs) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "list", Py_TYPE(__pyx_v_probs)->tp_name), 0))) __PYX_ERR(0, 426, __pyx_L1_error)
 ...
 */
      if (!(likely(PyList_CheckExact(__pyx_v_indices))||((__pyx_v_indices) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "list", Py_TYPE(__pyx_v_indices)->tp_name), 0))) __PYX_ERR(0, 428, __pyx_L1_error)
      if (!(likely(PyList_CheckExact(__pyx_v_probs))||((__pyx_v_probs) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "list", Py_TYPE(__pyx_v_probs)->tp_name), 0))) __PYX_ERR(0, 428, __pyx_L1_error)
 ...
 */
      if (!(likely(PyList_CheckExact(__pyx_v_indices))||((__pyx_v_indices) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "list", Py_TYPE(__pyx_v_indices)->tp_name), 0))) __PYX_ERR(0, 488, __pyx_L1_error)
      if (!(likely(PyList_CheckExact(__pyx_v_probs))||((__pyx_v_probs) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "list", Py_TYPE(__pyx_v_probs)->tp_name), 0))) __PYX_ERR(0, 488, __pyx_L1_error)
      if (unlikely(__pyx_v_stego == Py_None)) {
        PyErr_SetString(PyExc_TypeError, "'NoneType' object is not subscriptable");
 ...
 * 
 */
      if (!(likely(PyList_CheckExact(__pyx_v_indices))||((__pyx_v_indices) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "list", Py_TYPE(__pyx_v_indices)->tp_name), 0))) __PYX_ERR(0, 490, __pyx_L1_error)
      if (!(likely(PyList_CheckExact(__pyx_v_probs))||((__pyx_v_probs) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "list", Py_TYPE(__pyx_v_probs)->tp_name), 0))) __PYX_ERR(0, 490, __pyx_L1_error)
      if (unlikely(__pyx_v_stego == Py_None)) {
        PyErr_SetString(PyExc_TypeError, "'NoneType' object is not subscriptable");
